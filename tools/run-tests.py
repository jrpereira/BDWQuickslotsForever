...
def main():
    ...
    for name in TESTS:
        ...
        if result.returncode:
            failed.append(name)
    print('FAILED: ' + ', '.join(failed) if failed else 'PASS: 23 current Lua suites and 14 runtime syntax checks')
